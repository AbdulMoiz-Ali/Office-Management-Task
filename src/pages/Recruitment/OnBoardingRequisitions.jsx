...
const ongoingData = userData.filter((user) => user.status === "Onboarding");

const OnBoardingRequisitions = () => {
            ...
            <thead>
              <tr className="text-slate-500 font-light">
                ...
                <th className="px-4 py-2 text-left">
                  Department <IoIosArrowDown className="inline ml-1" />
                </th>
                <th className="px-2 py-2 text-left">
                  Recruitment Manager <IoIosArrowDown className="inline ml-1" />
                </th>
                <th className="px-4 py-2 text-left">
                  Status <IoIosArrowDown className="inline ml-1" />
                </th>
          ...
          {ongoingData.map((user, index) => (
            ...
            >
              ...
              <div className="text-sm text-gray-500">
                <div>
                  Date Posted:{" "}
                  <span className="text-gray-700">{user.datePosted}</span>
                </div>
                <div>
                  Required By:{" "}
                  <span className="text-gray-700">{user.requiredBy}</span>
                </div>
              </div>
            </div>
          ))}
...
export default OnBoardingRequisitions;
